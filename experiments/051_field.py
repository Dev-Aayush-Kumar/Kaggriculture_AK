"""E51 - smallest field check of H4.

Run only because E50 beat both H3 and P1-S on P(win) without harming
p10/p25. 8 paired seeds, both seats. Does not rerun historical tournaments.
"""
...
CHAMPION_PARAMS = dict(B.P1_S, harvest_defer_enabled=True,
                       harvest_defer_wool_only=True, endgame_rescue_feed=True)
