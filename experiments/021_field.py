"""E21 - field check of the E20 combination against P1 and the existing families.

QD is P1 plus sale_qty_floor=0.15 and sell_defer. Smallest directional sample:
8 paired seeds, both seats, versus P1, A, D, C, and the goose/wheat reference.
Does not rerun the historical round-robin.
"""
...
CHAMPION = "QD"
CHAMPION_PARAMS = dict(B.P1, sale_qty_enabled=True, sale_qty_floor=0.15,
...
def summarize(records, label):
    ...
    print(f"  milk/wool floor={milk_f:.1f}/{wool_f:.1f}")
