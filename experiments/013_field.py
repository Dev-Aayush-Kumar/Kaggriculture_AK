"""E13 - field check of the E12 champion against the existing families.

Smallest directional sample: 8 paired seeds, both seats, versus A, D, C, and
the original goose/wheat reference. Does not rerun the historical 96-episode
round-robin. If the champion is still B0, this is a sanity check that the cap
code did not change B0; B0 vs A and B0 vs C at 32 seeds already exist in E9.
"""
...
# Filled from E12: champion label and its Config overrides.
CHAMPION = "B2"
